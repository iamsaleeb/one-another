  ...
  return (
    <article className="prose prose-sm max-w-none">
      ...
      <ul className="list-disc space-y-1 pl-5">
        ...
        <li>
          <strong>Device token:</strong> a push notification token generated by
          your device so we can send you event reminders and updates — this is
          processed by Google Firebase Cloud Messaging
        </li>
        <li>
      ...
      <h2 className="mt-6 mb-2 text-lg font-semibold">4. Data Retention</h2>
      <p>
      ...
      <h2 className="mt-6 mb-2 text-lg font-semibold">5. Your Rights</h2>
      ...
      <ul className="list-disc space-y-1 pl-5">
        ...
        <li>
          Opt out of push notifications at any time via your profile settings
        </li>
      </ul>
      <p className="mt-2">
      ...
      <h2 className="mt-6 mb-2 text-lg font-semibold">6. Children</h2>
      <p>
      ...
      <h2 className="mt-6 mb-2 text-lg font-semibold">7. Security</h2>
      <p>
      ...
      <h2 className="mt-6 mb-2 text-lg font-semibold">9. Contact</h2>
      <p>
