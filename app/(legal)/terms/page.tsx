...
export default function TermsPage() {
  return (
    <article className="prose prose-sm max-w-none">
      ...
      <h2 className="mt-6 mb-2 text-lg font-semibold">2. Your Account</h2>
      <p>
      ...
      <h2 className="mt-6 mb-2 text-lg font-semibold">3. Acceptable Use</h2>
      ...
      <ul className="list-disc space-y-1 pl-5">
        ...
        <li>
          Use the platform for spam, advertising, or commercial solicitation
        </li>
        <li>
      ...
      <h2 className="mt-6 mb-2 text-lg font-semibold">4. Event Bookings</h2>
      <p>
      ...
      <p>
        ...
        ownership of any content you post, but you grant us a licence to display
        it within the app to provide the service.
      </p>

      <h2 className="mt-6 mb-2 text-lg font-semibold">7. Disclaimers</h2>
      <p>
        ...
        posted by organisers is accurate. We are not responsible for the conduct
        of users, organisers, or events listed on the platform.
      </p>
      ...
      <p>
        To the maximum extent permitted by law, 1Another and its operators will
      ...
      <p>
        ...
        significant changes via the app. Continued use after changes take effect
        constitutes acceptance of the updated terms.
      </p>

      <h2 className="mt-6 mb-2 text-lg font-semibold">10. Contact</h2>
      <p>
