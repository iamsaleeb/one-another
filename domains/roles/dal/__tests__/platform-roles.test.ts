...
import { getPlatformRole, getPlatformAdmins, upsertPlatformRole, removePlatformRole } from '../platform-roles'
  ...
  describe('upsertPlatformRole', () => {
    it('upserts PLATFORM_ADMIN', async () => {
      ...
      expect(mockUpsert).toHaveBeenCalledWith({
        ...
        create: { userId: 'u1', role: 'PLATFORM_ADMIN', assignedBy: 'assigner-1' },
      })
    })
  })
